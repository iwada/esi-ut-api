...
import io.medrem.payload.response.JwtResponse;
import io.medrem.payload.response.MessageResponse;
import io.medrem.repository.RoleRepository;
...
import io.medrem.payload.request.LoginRequest;
import io.medrem.payload.request.SignupRequest;
import io.medrem.security.jwt.JwtUtils;
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    if (strRoles == null) {
      ...
      strRoles.forEach(role -> {
        ...
        case "doctor":
          Role docRole = roleRepository.findByName(ERole.ROLE_PHYSICIAN)
              .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
          roles.add(docRole);
          break;
